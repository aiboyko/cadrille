...
def run(data_path, split, mode, checkpoint_path, py_path, n_samples=1):
...
if __name__ == '__main__':
    ...
    run(args.data_path, args.split, args.mode, args.checkpoint_path, args.py_path, args.n_samples)
